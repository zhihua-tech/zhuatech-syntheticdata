...
@Service public class SyntheticDataService{
 ...
 private final GenerationAuditRepository repository;public SyntheticDataService(GenerationAuditRepository r){repository=r;}
 ...
 public enum Decision{EXPORTABLE,PREVIEW_ONLY,BLOCKED}public enum RiskLevel{LOW,MEDIUM,HIGH}
}
